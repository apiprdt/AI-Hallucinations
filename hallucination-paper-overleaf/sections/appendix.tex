...
\begin{itemize}
    \item BBBP: ``penetrate the blood-brain barrier''
    \item BACE: ``inhibit the BACE-1 enzyme''
    \item Tox21: ``exhibit toxicity in the nuclear receptor 
    androgen receptor (NR-AR) assay''
    \item ESOL: ``have low aqueous solubility, consistent 
    with a logS value below the molecule's expected range''
\end{itemize}

Hallucination generation used temperature $= 0.9$, \texttt{max\_tokens} $= 150$, with the following type-specific prompts:

\subsubsection*{C3 (Free Hallucination):}
...
\subsubsection*{C4a (Structural Augmentation):}
