...
\subsubsection*{ESOL proxy framing.} The ESOL zero-shot prompt utilized a qualitative proxy framing (asking the LLM to predict the probability of ``having low aqueous solubility'') rather than direct scalar regression of logS values. Consequently, the reported RMSE measures the divergence of this pseudo-probability against scaled target values. This methodological choice restricts the interpretation of the ESOL results to directional trends in regression rather than absolute solubility error.
